...
Public Class frmKhachHang
    ...
    Private Sub Loaddata()
        ...
        Dim Query1 As SqlDataAdapter = New SqlDataAdapter("select * from Khach_Hang", connect)
    ...
    Private Sub dgvThongTin_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvThongTin.CellClick
        ...
        txtMaKH.Text = dgvThongTin.Item(0, index).Value
        txtEmail.Text = dgvThongTin.Item(4, index).Value
        txtTenKH.Text = dgvThongTin.Item(1, index).Value
        txtDT.Text = dgvThongTin.Item(2, index).Value
        txtDC.Text = dgvThongTin.Item(3, index).Value
    End Sub

    Private Sub btnThem_Click(sender As Object, e As EventArgs) Handles btnThem.Click
        Dim connect As SqlConnection = New SqlConnection(chuoiconnect)
        Dim Query2 As String = "insert into Khach_Hang values (@MaKH,@TenKH,@NgaySinh,@NgayVao,@DT,@DC,@Email)"
        ...
        Try
            ...
            ExecuteQuery1.Parameters.AddWithValue("@DT", txtDT.Text)
            ExecuteQuery1.Parameters.AddWithValue("@DC", txtDC.Text)
    ...
    Private Sub btnSua_Click(sender As Object, e As EventArgs) Handles btnSua.Click
        ...
        Dim Stradd1 As String = "Update Khach_Hang set Email = @Email, HoTen = @TenKH, DienThoai = @DT, DiaChi = @DC where MaKH = @MaKH"
        ...
        Try
            ...
            com.Parameters.AddWithValue("@DC", txtDC.Text)
    ...
    Private Sub btnXoa_Click(sender As Object, e As EventArgs) Handles btnXoa.Click
        ...
        ketnoi.Open()
        Dim xoadl As String = "Delete from Khach_Hang Where MaKH = @MaKH"
